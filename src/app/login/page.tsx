...
export default function LoginPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push("/dashboard/coa-database");
    } catch (err: unknown) {
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/80 backdrop-blur-xl border border-slate-200/50 rounded-3xl p-8 shadow-2xl">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 border border-slate-300 rounded-xl text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition-all bg-white"
              ...
              <div className="mt-8 pt-6 border-t border-slate-200/50 text-center space-y-3">
                ...
                <Link href="/register" className="inline-flex items-center gap-2 text-sm text-slate-700 hover:text-slate-900 transition-colors font-medium">
